...
static const char qt_meta_stringdata_PropertiesEditor[] = {
    "PropertiesEditor\0\0updatePropertiesAndClose()\0"
};

const QMetaObject PropertiesEditor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PropertiesEditor,
      qt_meta_data_PropertiesEditor, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PropertiesEditor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PropertiesEditor))
...
int PropertiesEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updatePropertiesAndClose(); break;
        default: ;
        }
        _id -= 1;
    }
